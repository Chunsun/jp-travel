...
const TRAVEL_DATA = {
    locations: [
        ...
        { name: '清水寺', lat: 34.9949, lng: 135.7849, region: 'kyoto', type: 'heritage', 
          color: '#e74c3c', date: '7/15', day: 1, duration: '2小時', priority: 'must-see',
        ...
        { name: '三十三間堂', lat: 34.9880, lng: 135.7717, region: 'kyoto', type: 'temple', 
          ...
          features: ['1001尊千手觀音'], description: '1001尊千手觀音像，重要文化體驗', openHours: '8:00-17:00' },
        ...
        { name: '出町桝形商店街', lat: 35.0306, lng: 135.7639, region: 'kyoto', type: 'nature', 
          ...
          features: ['在地人市場', '鯖街道終點'], description: '在地人生鮮市場，觀光客少、價格合理', openHours: '8:00-18:00' },
        ...
        { name: '貴船神社', lat: 35.1128, lng: 135.7631, region: 'kyoto', type: 'shrine', 
          ...
          features: ['水神總本宮', '三社詣', '水占卜'], description: '水神總本宮，完整三社詣體驗', openHours: '6:00-20:00' },
        ...
        { name: '平等院', lat: 34.8889, lng: 135.8075, region: 'kyoto', type: 'heritage', 
          ...
          features: ['世界遺產', 'UNESCO', '鳳凰堂'], description: '平安時代建築傑作，十円硬幣圖案', openHours: '9:30-10:45' },
        { name: '宇治上神社', lat: 34.8906, lng: 135.8094, region: 'kyoto', type: 'heritage', 
          color: '#9b59b6', date: '7/19', day: 5, duration: '45分鐘', priority: 'important',
          features: ['世界遺產', 'UNESCO', '日本最古神社'], description: '日本現存最古老的神社建築', openHours: '10:45-11:30' },
        { name: '中村藤吉本店', lat: 34.8878, lng: 135.8061, region: 'kyoto', type: 'nature', 
          color: '#9b59b6', date: '7/19', day: 5, duration: '1小時', priority: 'important',
          features: ['宇治茶文化', '懷石午餐'], description: '重點茶文化體驗，懷石午餐', openHours: '11:30-12:30' },
        ...
        { name: '太秦映畫村', lat: 35.0139, lng: 135.7081, region: 'kyoto', type: 'nature', 
          color: '#1abc9c', date: '7/20', day: 6, duration: '2小時', priority: 'optional',
          features: ['江戶時代體驗'], description: '日本古裝電影拍攝場地主題樂園', openHours: '9:05-11:15' },
        { name: '嵯峨野小火車', lat: 35.0167, lng: 135.6789, region: 'kyoto', type: 'nature', 
          ...
          features: ['保津峽風景'], description: '穿越保津峽的觀光小火車', openHours: '12:35-13:00' },
        { name: '京馬車', lat: 35.0167, lng: 135.6189, region: 'kyoto', type: 'nature', 
          color: '#1abc9c', date: '7/20', day: 6, duration: '30分鐘', priority: 'must-see',
          features: ['復古馬車體驗'], description: '馬蹄聲中穿越田園風光，復古馬車文化體驗', openHours: '13:05-13:35' },
        ...
        { name: '二條陣屋', lat: 35.0097, lng: 135.7472, region: 'kyoto', type: 'castle', 
          color: '#16a085', date: '7/21', day: 7, duration: '1.5小時', priority: 'important',
          features: ['武家住宅', '24處機關'], description: '江戶時代武家住宅，隱藏24處防禦機關', openHours: '10:00-11:30' },
        { name: '二條城', lat: 35.0142, lng: 135.7481, region: 'kyoto', type: 'heritage', 
          color: '#16a085', date: '7/21', day: 7, duration: '1小時', priority: 'must-see',
          features: ['世界遺產', 'UNESCO', '德川幕府'], description: '德川幕府在京都的政治中心', openHours: '12:00-13:00' },

        // 有馬溫泉 (7/21-22)
        { name: '有馬溫泉', lat: 34.7972, lng: 135.2486, region: 'osaka', type: 'onsen', 
          color: '#16a085', date: '7/21-22', day: 7, duration: '一晚', priority: 'must-see',
          features: ['日本三古湯', '金湯銀湯'], description: '日本三大古湯之一，以金泉銀泉聞名', openHours: '16:00入住' },

        // 姬路+神戶 (7/22)
        { name: '姬路城', lat: 34.8394, lng: 134.6939, region: 'osaka', type: 'castle', 
          color: '#8e44ad', date: '7/22', day: 8, duration: '2.5小時', priority: 'must-see',
          features: ['世界遺產', 'UNESCO', '國寶天守閣'], description: '日本現存12座天守之一，白鷺城美稱', openHours: '11:30-14:00' },
        { name: '書寫山圓教寺', lat: 34.8567, lng: 134.6328, region: 'osaka', type: 'temple', 
          color: '#8e44ad', date: '7/22', day: 8, duration: '1小時', priority: 'optional',
          features: ['西國三十三所'], description: '西國三十三所靈場之一', openHours: '15:00-16:00' },
        ...
        { name: '摩耶山星の駅', lat: 34.7284, lng: 135.2332, region: 'osaka', type: 'nature', 
          color: '#8e44ad', date: '7/22', day: 8, duration: '1.5小時', priority: 'must-see',
        ...
        { name: '大阪天滿宮', lat: 34.7017, lng: 135.5097, region: 'osaka', type: 'shrine', 
          color: '#c0392b', date: '7/24', day: 10, duration: '4小時', priority: 'important',
          features: ['學問之神'], description: '供奉菅原道真的學問之神', openHours: '18:00-22:00' },
        ...
        { name: '天神祭本宮', lat: 34.7018, lng: 135.5097, region: 'osaka', type: 'festival', 
          ...
          features: ['日本三大祭', '船渡御', '奉納花火'], description: '天神祭本宮最高潮，船渡御+奉納花火', openHours: '13:30-21:24' },        // 東京區域 (7/25-30)
        ...
        { name: '澀谷', lat: 35.6598, lng: 139.7006, region: 'tokyo', type: 'nature', 
          color: '#9b59b6', date: '7/29', day: 15, duration: '9小時', priority: 'important',
          features: ['文化散步', '原宿', '表參道', '美妝天堂'], description: '東京深度文化體驗：澀谷→代官山→中目黑→原宿+表參道購物', openHours: '9:00-18:00' },
